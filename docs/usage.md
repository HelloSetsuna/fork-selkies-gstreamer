...
```bash
docker run --pull=always --name selkies -it -d --rm -p 8080:8080 -p 3478:3478 ghcr.io/hellosetsuna/fork-selkies-gstreamer/gst-py-example:main-ubuntu${DISTRIB_RELEASE}
